...
class Grid:
    ...
    def __init__(self, width, height, initialValue=False, bitRepresentation=None, data=None):
    ...
    def copy(self):
        g = Grid(self.width, self.height, data=[x[:] for x in self.data])
    ...
    def shallowCopy(self):
        g = Grid(self.width, self.height, data=self.data)
        # g.data = self.data
        return g
...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            ...
            self.score = prevState.score.copy()
        ...
        self._lose = False
        self._win = False
        self.scoreChange = [0 for _ in prevState.score] if prevState else []
    ...
    def __hash__(self):
        ...
        for i, state in enumerate(self.agentStates):
            try:
                ...
                print(e)
                # hash(state)
        return int((hash(tuple(self.agentStates)) + 13*hash(self.food) + 113 * hash(tuple(self.capsules)) + 7 * hash(tuple(self.score))) % 1048575)
    ...
    def __str__(self):
        ...
        return str(map) + "\nScore: " + ' '.join([f'{s}' for s in self.score]) + '\n'
    ...
    def initialize(self, layout, numGhostAgents):
        ...
        self.score = [0] * layout.getNumPacman()
        self.scoreChange = [0] * layout.getNumPacman()
